...
describe('class Portfolio', () => {
  describe('method setPositions', () => {
    test('it can add data-pos attribute to 1 card element', () => {
    ...
    test('it can add data-pos attribute to mutliple card elements', () => {
  ...
  describe('method._resortItems', () => {
    test('it creates an AJAX call to update sort order', () => {
